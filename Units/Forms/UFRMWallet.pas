...
{$ENDIF}
  ...
  UNetProtocol, UCrypto, Buttons, UPoolMining, URPC, UFRMAccountSelect, LCLTranslator, Types;
...
begin
  ...
  if FMessagesUnreadCount>1 then lblReceivedMessages.Caption := Format(
    rsYouHaveRecei, [FMessagesUnreadCount])
